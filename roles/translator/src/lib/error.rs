...
pub type ProxyResult<'a, T> = core::result::Result<T, TProxyError<'a>>;
...
impl<'a> From<TProxyDownstreamError<'a>> for TProxyError<'a> {
    fn from(e: TProxyDownstreamError<'a>) -> Self { TProxyError::Downstream(e) }
}

impl<'a> From<TProxyUpstreamError<'a>> for TProxyError<'a> {
    fn from(e: TProxyUpstreamError<'a>) -> Self { TProxyError::Upstream(e) }
}

impl<'a> From<TProxyBridgeError<'a>> for TProxyError<'a> {
    fn from(e: TProxyBridgeError<'a>) -> Self { TProxyError::Bridge(e) }
}
